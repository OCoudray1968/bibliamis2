 ...
 */
final class Version20210421055738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE books ADD genders_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE gender_book (gender_id INT NOT NULL, book_id INT NOT NULL, INDEX IDX_2A20E2AB16A2B381 (book_id), INDEX IDX_2A20E2AB708A0E0 (gender_id), PRIMARY KEY(gender_id, book_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
