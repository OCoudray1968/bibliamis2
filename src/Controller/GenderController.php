...
{
    /**
     * @Route("/", name="gender.index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="gender.new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="gender.show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="gender.edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="gender.delete", methods={"DELETE"})
     */
